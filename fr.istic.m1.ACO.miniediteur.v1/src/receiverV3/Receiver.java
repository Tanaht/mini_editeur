 ...
 * Et interface Originator du design pattern Memento
 * @author Antoine
 *
 */
public interface Receiver {
	...
	/**
	 * Créer un memento représentant l'état du moteur
	 * @return
	 */
	MementoMoteur createMemento();
	
	/**
	 * Met à jour l'état du moteur avec le memento donnée en paramètre
	 * @param memento le memento contenant l'état du moteur à utiliser
	 */
