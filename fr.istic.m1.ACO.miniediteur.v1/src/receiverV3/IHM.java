...
public interface IHM {
	...
	/**
	 * Setter qui donne la commande Redo à l'IHM
	 * @param redo une instance de Redo
	 */
	void setRedo(Command redo);
	
	/**
	 * Setter qui donne la commande Undo à l'IHM
	 * @param undo une instance de Undo
	 */
	void setUndo(Command undo);
}